...
/* Q1
todo: (Destructure the countries object print name, capital, population and languages of all countries)*/

countries.forEach(e => {
    let {name, capital, population, languages} = e;
    console.log(`"Name: ${name} Capital: ${capital} Populatin: ${population} Languages: ${languages} "`)
})  

/* Q2
todo: (A junior developer structure student name, skills and score in array of arrays which may not easy to read. 
todo:   Destructure the following array name to name, skills array to skills, scores array to scores, 
todo: JavaScript score to jsScore and React score to reactScore variable in one line.) */

const student = ['David', ['HTM', 'CSS', 'JS', 'React'], [98, 85, 90, 95]]
let [namess, skills, [, , jsScore, reactScore]] = student;
console.log(namess, skills, jsScore, reactScore);
...
function convertArrayToObject(arr) {
    let empty = Array()
    for (let obj of arr) {
        let [name, skills, score] = obj;
        let add = { name: name, skills: skills, score: score };
        empty.push(add)
    }
...
/* Q4
todo (copy without mutating and add something) */
...
let copy = {
    ... student2,
    skills:{frontEnd: [{skill:"Bootstrao", Level:8}],...skills}}
